...
contract Ballot {
    ...
    uint startTime;
    modifier stageCorrect(Stage curstage, Stage correctstage){
        require(curstage==correctstage);
        _;
    }
    modifier register(address toVoter){
    ...
    function register(address toVoter) public stageCorrect(stage, Stage.Reg) register(toVoter){
